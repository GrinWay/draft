...
use App\Validator\Telegram\TelegramAmountWithEndFigures;
...
class TelegramLabeledPrices implements \ArrayAccess, \Countable, \Iterator
{
    ...
    private function addSum(TelegramLabeledPrice $labeledPrice): static
    {
        ...
        $this->sumFigures = FiguresRepresentation::concatNumbersWithCorrectCountOfEndFigures($startSum, $endSum);
        return $this;
    }
